  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ inset: size * 0.13, border: '1px solid rgba(247,244,236,0.55)' }}
      />
      <span
        className="relative font-serif font-medium"
        style={{ color: '#F7F4EC', fontSize: size * 0.46, lineHeight: 1 }}
      >
        {char}
      </span>
    </span>
...
export function CornerMark({
  ...
  const pos = { tl: 'left-0 top-0', tr: 'right-0 top-0', bl: 'left-0 bottom-0', br: 'right-0 bottom-0' }[position]
  return (
    <span
      aria-hidden="true"
    ...
    >
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M2 11 L2 2 L11 2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
        <path d="M6 11 L6 6 L11 6" stroke="currentColor" strokeWidth="1" strokeLinecap="round" opacity="0.6" />
      </svg>
    </span>
  )
}
